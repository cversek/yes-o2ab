...
class ConditionFields(Frame):
    def __init__(self, parent):
        ...
        self.fields['SA_press_raw_voltage'] = Pmw.EntryField(parent,
                                                 labelpos    = 'w',
                                                 label_text  = " Spect. Air (SA) Press. [Raw Volt.]:",
                                                 label_font  = FIELD_LABEL_FONT,
                                                 entry_width = CONDITION_FIELDS_ENTRY_WIDTH,
                                                 entry_state = 'readonly',
                                                 )
        self.fields['SA_temp_raw_voltage'] = Pmw.EntryField(parent,
                                                 labelpos    = 'w',
                                                 label_text  = " Spect. Air (SA) Temp.  [Raw Volt.]:",
                                                 label_font  = FIELD_LABEL_FONT,
                                                 entry_width = CONDITION_FIELDS_ENTRY_WIDTH,
                                                 entry_state = 'readonly',
                                                 )
        self.fields['SA_humid_raw_voltage'] = Pmw.EntryField(parent,
                                                 labelpos    = 'w',
                                                 label_text  = " Spect. Air (SA) Humid. [Raw Volt.]:",
                                                 label_font  = FIELD_LABEL_FONT,
                                                 entry_width = CONDITION_FIELDS_ENTRY_WIDTH,
                                                 entry_state = 'readonly',
                                                 )
